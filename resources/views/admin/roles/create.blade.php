...
<div class="w-full px-4 py-8">
    <div class="max-w-7xl mx-auto">
        <h1 class="text-2xl font-bold text-gray-900 mb-6">Create New Role</h1>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="text" name="display_name" id="display_name" value="{{ old('display_name') }}"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500 @error('display_name') border-red-500 @enderror">
