...
// Set up the real-time listener specifically for pending orders
    ...
    setupRealTimePendingOrdersListener('{{$status}}', csrfToken);


    setupRealTimePendingApplicationsListener('{{$status}}', csrfToken);
    ...
    window.onload = initializeDashboard;
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">KYC Applications</h3>
